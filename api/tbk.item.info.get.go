...
type TbkItemInfo struct {
	...
	i_rfd_rate        bool                `json:"i_rfd_rate"`
	h_good_rate       bool                `json:"h_good_rate"`
	h_pay_rate30      bool                `json:"h_pay_rate30"`
	free_shipment     bool                `json:"free_shipment"`
	material_lib_type string              `json:"material_lib_type"`
}
